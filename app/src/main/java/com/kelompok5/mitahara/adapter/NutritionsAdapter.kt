...
class NutritionsAdapter : RecyclerView.Adapter<NutritionsAdapter.NutritionsViewHoler>() {
    ...
    override fun onCreateViewHolder(
        ...
        return NutritionsViewHoler(ItemNutritionsBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    inner class NutritionsViewHoler(val binding : ItemNutritionsBinding) : RecyclerView.ViewHolder(binding.root){
